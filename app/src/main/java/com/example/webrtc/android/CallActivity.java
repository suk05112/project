...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
    ...
    private RoomConnectionParameters roomConnectionParameters;  // 영상통화를 웹소켓(https://appr.tc)을 통해 시작할 경우. Signalling 서버를 대신하는 AsyncTask 클래스.
    @Nullable
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /**강섭 - 이부분에서 webSocket인지 TCP소켓인지 구분한다.*/
